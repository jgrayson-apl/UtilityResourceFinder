...
class AppBase extends AppParameters {
  ...
  initializeSidePanels() {
    ...
    this.togglePanel = (toggleId, active) => {
      ...
      toggleActions.forEach(actionNode => {
        actionNode.active = (actionNode.dataset.toggle === toggleId);
      });
      // PANELS //
  ...
  configureAppInfo() {
    ...
    this.title = applicationTitleNode.innerHTML;
    ...
    applicationDescriptionNode && (this.description = applicationDescriptionNode.innerHTML);
